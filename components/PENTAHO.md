...
- [Download](https://sourceforge.net/projects/pentaho/) the latest version of Pentaho's Community Edition: Data Integration. For Linux/Ubuntu you can download the zip file from [here](https://privatefilesbucket-community-edition.s3.us-west-2.amazonaws.com/9.4.0.0-343/ce/client-tools/pdi-ce-9.4.0.0-343.zip).
...
- Add "PENTAHO\_HOME" as environment variable:
  ...
  - Linux: Add following line to the `/etc/environment` file: `PENTAHO_HOME="/home/shared/pdi"`
...
5. You can now commit and push these changes to GitHub (for most AusCAT centres, this is being tracked in the [auscat_etl_centres](`https://github.com/AustralianCancerDataNetwork/auscat_etl_centres`) repo)
